...
public class ConsumableServiceImpl implements ConsumableService{
	...
	public Page<ConsumableCardDTO> findByName(String name, Integer page,Pageable pageable) {
		int size = 4;
	...
	public Page<ConsumableCardDTO> findByPriceByOrdemByAsc(Pageable pageable, Integer page) {
		int size = 4;
	...
	public Page<ConsumableCardDTO> findByPriceByOrdemByDesc(Pageable pageable, Integer page) {
		int size = 4;
	...
	public Page<ConsumableCardDTO> findAll(Pageable pageable, Integer page) {
		int size = 4;
